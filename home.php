...
<div class="panel panel-primary">
  <div class="panel-heading"><b>Get Your Expense and Manage it.</b></div>
...
<blockquote>
<h4 id="media-heading" class="media-heading"><b>Welcome <?php    echo $_SESSION['unaam']; ?></b> <a href='signout.php'  class="button pull-right" >Logout</a></h4> 
...
?></span>
<!-- Today's Pocket Money Start-->
<br><strong>Today's Pocket Money :</strong> <span class="label label-danger" id='exptop'><?php 
...
?></span>
<!-- Today's Pocket Money End -->

<br><strong>Total Pocket Money :</strong> <span class="label label-danger" id='exptop'><?php 
...
$tesum = $psum['SUM(pprice)']; 
if ($tesum== '')
{echo "Add Pocket Money to display here";}
else
{echo $tesum;}
} 
...
<?php if ($rbalance<=0) {
  # code...
  echo "<span class='label label-danger'>You are in loss";
}else{
  echo "<span class='label label-success'>Good Going";
}
?></span></blockquote>
</div>
...
<div class="panel panel-warning">
  <div class="panel-heading">
    <span class="glyphicon glyphicon-copy" aria-hidden="true"></span> Add Pocket Money/Income Detail
  </div>
  <div class="panel-body">
...
<div class="panel panel-warning">
  <div class="panel-heading">
    <span class="glyphicon glyphicon-search" aria-hidden="true"></span> Trace Pocket Money Record
  </div>
  <div class="panel-body">
  <div class="col-lg-8">
...
if ($ppsum !='')
{
echo '<b>'.$expdetail.'</b>  Pocket Money <span class="label label-danger">'.$ppsum.'</span> ';
}
else {echo ' Pocket Money <span class="label label-danger">NIL</span>';}
} 
